...
from FoundingTitanRobot import LOGGER, TITANSHIFTERS, SCOUTS, GARRISONS, application
...
REPORT_GROUP = 12
REPORT_IMMUNE_USERS = TITANSHIFTERS + SCOUTS + GARRISONS
...
ADMIN_REPORT_HANDLER = MessageHandler(filters.Regex(r"(?i)@admins(s)?"), report, block=False)
