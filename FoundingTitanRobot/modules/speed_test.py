import speedtest
from FoundingTitanRobot import ACKERMANS, application
...
async def speedtestxyz_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.from_user.id in ACKERMANS:
        ...
        await query.answer("You are required to join Heroes Association to use this command.")
