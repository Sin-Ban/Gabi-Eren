...
DB_URI = os.getenv("DATABASE_URL", "postgresql://gabidb_owner:EaIO2mJxk1pY@ep-white-paper-a1srio5h-pooler.ap-southeast-1.aws.neon.tech/gabidb?sslmode=require&channel_binding=require")
