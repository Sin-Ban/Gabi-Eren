...
DB_URI = os.getenv("DATABASE_URL", "postgresql://postgres:LVAynVJucgmnpPJgvjHxApYouRllhDnW@autorack.proxy.rlwy.net:42023/railway")
...
REDIS_URL = os.getenv("REDIS_URI", "redis://default:hYivzwlOSQpTJJBHcuLDbYtpekATyEwJ@autorack.proxy.rlwy.net:14734")
