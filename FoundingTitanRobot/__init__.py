...
DB_URI = os.getenv("DATABASE_URL", "postgresql://neondb_owner:npg_wvNuaE56iVrt@ep-twilight-boat-a1egm8i6-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
