...
DB_URI = os.getenv("DATABASE_URL", "postgresql://neondb_owner:npg_hlN0Yq9rDvoU@ep-fancy-lake-a1vz636z-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
