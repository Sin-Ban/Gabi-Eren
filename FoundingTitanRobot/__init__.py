...
DB_URI = os.getenv("DATABASE_URL", "postgresql://gabidb_owner:EaIO2mJxk1pY@ep-white-paper-a1srio5h-pooler.ap-southeast-1.aws.neon.tech/gabidb?sslmode=require&options=endpoint%3Dep-white-paper-a1srio5h")
