...
DB_URI = os.getenv("DATABASE_URL", "postgresql://gabidb_owner:npg_uUqmFI9bdV4y@ep-cool-lab-a142ebve-pooler.ap-southeast-1.aws.neon.tech/gabidb?sslmode=require&channel_binding=require")
